      ...
      <div>
              ...
              <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
                ...
                <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
                  ...
                  <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                    ...
                    <Link
                      to="https://www.instagram.com/invites/contact/?i=1t4t40tt9blmz&utm_content=qeiih78"
                      className="pl-4"
                    >
          ...
          <div className="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
            <div className="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
              ...
              <p className="pt-6 font-body leading-relaxed text-grey-20">
                infinity, This company working in Smart watch, Android watch,
                Advanced Technology Watch, a and all types watch are available.
              </p>
            ...
            <div className="group rounded px-8 py-12 shadow hover:bg-primary">
              ...
              <div className="text-center">
                <h3 className="pt-8 text-lg font-semibold uppercase text-primary group-hover:text-yellow lg:text-xl">
                  <Link to="career">smart watch developments</Link>
                </h3>
        ...
        <div className="container py-16 md:py-20" id="portfolio">
          ...
          <div className="mx-auto grid w-full grid-cols-1 gap-8 pt-12 sm:w-3/4 md:gap-10 lg:w-full lg:grid-cols-2">
            <Link className="mx-auto transform transition-all hover:scale-105 md:mx-0">
              <img
                src="/cogni2.jpeg"
            ...
            <div className="mx-auto grid w-full grid-cols-1 gap-6 pt-12 sm:w-3/4 lg:w-full lg:grid-cols-3 xl:gap-10">
              <Link to="/post" className="shadow">
                ...
                <div className="bg-white py-6 px-5 xl:py-8">
                  ...
                  <span className="block pt-2 font-body text-grey-20">
                    smartwatch development is the work involved in developing a
                    advance watch for the Internet (World Wide Web) or an
                    intranet (a private network). Web development can range from
              ...
              <Link to="/post" className="shadow">
                ...
                <div className="bg-white py-6 px-5 xl:py-8">
                  ...
                  <span className="block pt-2 font-body text-grey-20">
                    Mobile application is the process of creating software
                    applicationsin watch that run on a mobile device, and a
              ...
              <Link to="/post" className="shadow">
                ...
                <div className="bg-white py-6 px-5 xl:py-8">
                  ...
                  <span className="block pt-2 font-body text-grey-20">
                    Advanced designes create visual communications such as
